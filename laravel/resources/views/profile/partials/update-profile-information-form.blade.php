<section>
    ...
    <form method="post" action="{{ lroute('profile.update') }}" class="mt-6 space-y-5">
        @csrf
        @method('patch')
            ...
            @if ($user instanceof \Illuminate\Contracts\Auth\MustVerifyEmail && ! $user->hasVerifiedEmail())
                <div>
                    <p class="text-sm mt-2 text-gray-800">
                        ...
                        <button form="send-verification" class="underline text-sm text-cyan-700 hover:text-cyan-800 transition">
